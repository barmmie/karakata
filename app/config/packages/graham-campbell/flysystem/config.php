...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'awss3' => [
            'driver'     => 'awss3',
            'key'        => Setting::get('storage_awss3_access_key_id', ''),
            'secret'     => Setting::get('storage_awss3_secret_access_key', ''),
            'bucket'     => Setting::get('storage_awss3_bucket', ''),
             'region'     => Setting::get('storage_awss3_region_name', ''),
            // 'base_url'   => 'your-url',
            // 'options'    => array(),
            // 'prefix'     => 'your-prefix',
             'visibility' => 'public',
        ...
        'dropbox' => [
            'driver'     => 'dropbox',
            'token'      =>  Setting::get('storage_dropbox_app_token', ''),
            'app'        =>  Setting::get('storage_dropbox_app_name', ''),
            // 'prefix'     => 'your-prefix',
             'visibility' => 'public',
            // 'eventable'  => true,
            // 'cache'      => 'foo'

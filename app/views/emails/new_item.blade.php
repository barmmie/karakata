...
<head>
    ...
    <title>{{trans('phrases.new_item_posted')}} - {{Setting::get('site_name')}}</title>
                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0" itemprop="action" itemscope
                    ...
                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="content-wrap"
                            ...
                            valign="top">
                            <meta itemprop="name" content="{{trans('phrases.new_item_posted')}}"
                                  style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"/>
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        {{trans('phrases.new_item_posted')}} - {{$item->title}}
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        {{trans('phrases.item_subject_to_verification')}}

...
(function (window, $, undefined) {
    ...
    $.html5imageupload = function html5imageupload(options, element) {
        ...
        //buttons
        this.button				= {}
        this.button.edit		= '<div class="ui icon button tiny  blue btn-edit" title="' + (this.options.editTitle || 'Edit') + '"><i class="icon edit"></i></div>'
        this.button.saving		= '<div class="ui icon button tiny  yellow saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="icon  time"></i></div>';
        this.button.zoomin		= '<div class="ui icon button tiny  gray btn-zoom-in" title="' + (this.options.zoominTitle || 'Zoom in') + '"><i class="icon zoom"></i></div>';
        this.button.zoomout		= '<div class="ui icon button tiny  gray btn-zoom-out" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><i class="icon zoom out"></i></div>';
        this.button.zoomreset	= '<div class="ui icon button tiny  gray btn-zoom-reset" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><i class="icon  maximize"></i></div>';
//		this.button.rotatecw	= '<div class="ui icon button tiny  gray btn-rotate-cw" title="' + (this.options.cwTitle || 'Rotate clockwise') + '"><i class="icon  share"></i></div>';
//		this.button.rotateccw	= '<div class="ui icon button tiny  gray btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="icon  share icon-flipped"></i></div>';
        this.button.cancel		= '<div class="ui icon button tiny  red btn-cancel" title="' + (this.options.cancelTitle || 'Cancel') + '"><i class="icon remove"></i></div>';
        this.button.done		= '<div class="ui icon button tiny  teal btn-ok" title="' + (this.options.okTitle || 'Ok') + '"><i class="icon check"></i></div>';
        this.button.del			= '<div class="ui icon button tiny  red btn-del" title="' + (this.options.delTitle || 'Delete') + '"><i class="icon  trash"></i></div>';

        this.button.download	= '<a class="ui button tiny btn-warning download"><i class="icon  download"></i> ' + (this.options.downloadLabel || 'Download') + '</a>';

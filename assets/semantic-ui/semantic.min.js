...
!function (e, t, n, i) {
    ...
    e.fn.form = function (t) {
        ...
        return a.each(function () {
            var f, g, p, v, h, b, y, x, C, w, k, S, T, A, R, P, E, O, F = e(this), D = this, q = [], j = !1;
            O = {
                initialize: function () {
                    O.get.settings(), d ? (E === i && O.instantiate(), O.invoke(l)) : (O.verbose("Initializing form validation", F, x), O.bindEvents(), O.set.defaults(), O.instantiate())
                }, instantiate: function () {
                    O.verbose("Storing instance of module", O), E = O, F.data(R, O)
                }, destroy: function () {
                    O.verbose("Destroying previous module", E), O.removeEvents(), F.removeData(R)
                }, refresh: function () {
                    O.verbose("Refreshing selector cache"), f = F.find(k.field), g = F.find(k.group), p = F.find(k.message), v = F.find(k.prompt), h = F.find(k.submit), b = F.find(k.clear), y = F.find(k.reset)
                }, submit: function () {
                    O.verbose("Submitting form", F), F.submit()
                }, attachEvents: function (t, n) {
                    n = n || "submit", e(t).on("click" + P, function (e) {
                        O[n](), e.preventDefault()
                    })
                }, bindEvents: function () {
                    O.verbose("Attaching form events"), F.on("submit" + P, O.validate.form).on("blur" + P, k.field, O.event.field.blur).on("click" + P, k.submit, O.submit).on("click" + P, k.reset, O.reset).on("click" + P, k.clear, O.clear), x.keyboardShortcuts && F.on("keydown" + P, k.field, O.event.field.keydown), f.each(function () {
                        var t = e(this), n = t.prop("type"), i = O.get.changeEvent(n, t);
                        e(this).on(i + P, O.event.field.change)
                    })
                }, clear: function () {
                    f.each(function () {
                        ...
                        c && (O.verbose("Resetting error on field", i), i.removeClass(S.error), o.remove()), s ? (O.verbose("Resetting dropdown value", n, a), n.dropdown("clear")) : r ? t.prop("checked", !1) : (O.verbose("Resetting field value", t, a), t.val(""))
                    })
                }, reset: function () {
                    f.each(function () {
                        ...
                        r !== i && (l && (O.verbose("Resetting error on field", o), o.removeClass(S.error), a.remove()), c ? (O.verbose("Resetting dropdown value", n, r), n.dropdown("restore defaults")) : s ? (O.verbose("Resetting checkbox value", n, r), t.prop("checked", r)) : (O.verbose("Resetting field value", t, r), t.val(r)))
                    })
                }, is: {
                    valid: function () {
                        var t = !0;
                        return O.verbose("Checking if form is valid"), e.each(C, function (e, n) {
                            O.validate.field(n) || (t = !1)
                        }), t
                    }
                }, removeEvents: function () {
                    F.off(P), f.off(P), h.off(P), f.off(P)
                }, event: {
                    field: {
                        keydown: function (t) {
                            var n = e(this), i = t.which, o = {enter: 13, escape: 27};
                            i == o.escape && (O.verbose("Escape key pressed blurring field"), n.blur()), !t.ctrlKey && i == o.enter && n.is(k.input) && n.not(k.checkbox).length > 0 && (j || (n.one("keyup" + P, O.event.field.keyup), O.submit(), O.debug("Enter pressed on input submitting form")), j = !0)
                        }, keyup: function () {
                            j = !1
                        }, blur: function () {
                            var t = e(this), n = t.closest(g), i = O.get.validation(t);
                            n.hasClass(S.error) ? (O.debug("Revalidating field", t, i), O.validate.field(i)) : ("blur" == x.on || "change" == x.on) && O.validate.field(i)
                        }, change: function () {
                            var t = e(this), n = t.closest(g);
                            ("change" == x.on || n.hasClass(S.error) && x.revalidate) && (clearTimeout(O.timer), O.timer = setTimeout(function () {
                    ...
                    changeEvent: function (e, t) {
                        ...
                        if (e.isPlainObject(t)) {
                            var n = Object.keys(t), o = n.length > 0 ? t[n[0]].identifier !== i : !1;
                            o ? (x = e.extend(!0, {}, e.fn.form.settings, u), C = e.extend({}, e.fn.form.settings.defaults, t), O.error(x.error.oldSyntax, D), O.verbose("Extending settings from legacy parameters", C, x)) : (x = e.extend(!0, {}, e.fn.form.settings, t), C = e.extend({}, e.fn.form.settings.defaults, x.fields), O.verbose("Extending settings", C, x))
                        } else x = e.fn.form.settings, C = e.fn.form.settings.defaults, O.verbose("Using default form validation", C, x);
                        A = x.namespace, w = x.metadata, k = x.selector, S = x.className, T = x.error, R = "module-" + A, P = "." + A, E = F.data(R), O.refresh()
                    }, field: function (t) {
                        return O.verbose("Finding field with identifier", t), f.filter("#" + t).length > 0 ? f.filter("#" + t) : f.filter('[name="' + t + '"]').length > 0 ? f.filter('[name="' + t + '"]') : f.filter('[name="' + t + '[]"]').length > 0 ? f.filter('[name="' + t + '[]"]') : f.filter("[data-" + w.validate + '="' + t + '"]').length > 0 ? f.filter("[data-" + w.validate + '="' + t + '"]') : e("<input/>")
                    }, fields: function (t) {
                        var n = e();
                        ...
                        var n;
                        return C ? (e.each(C, function (e, i) {
                            O.get.field(i.identifier)[0] == t[0] && (n = i)
                        }), n || !1) : !1
                    }, value: function (e) {
                        var t, n = [];
                        return n.push(e), t = O.get.values.call(D, n), t[e]
                    }, values: function (t) {
                        var n = e.isArray(t) ? O.get.fields(t) : f, i = {};
                        return n.each(function (t, n) {
                            ...
                            if (a)if (l)if (a = a.replace("[]", ""), i[a] || (i[a] = []), s) {
                                if (!u)return O.debug("Omitted unchecked checkbox", o), !0;
                                i[a].push(r)
                            } else i[a].push(r); else if (c)u && (i[a] = r); else if (s) {
                                if (!u)return O.debug("Omitted unchecked checkbox", o), !0;
                                i[a] = !0
                            } else i[a] = r
                        }), i
                    ...
                    field: function (e) {
                        return O.verbose("Checking for existence of a field with identifier", e), f.filter("#" + e).length > 0 ? !0 : f.filter('[name="' + e + '"]').length > 0 ? !0 : f.filter("[data-" + w.validate + '="' + e + '"]').length > 0 ? !0 : !1
                    }
                }, add: {
                    prompt: function (t, n) {
                        ...
                        O.debug("Adding form error messages", e), p.html(x.templates.error(e))
                    }
                }, remove: {
                    prompt: function (t) {
                        var n = O.get.field(t.identifier), o = n.closest(g), a = o.children(k.prompt);
                        o.removeClass(S.error), x.inline && a.is(":visible") && (O.verbose("Removing prompt for field", t), x.transition && e.fn.transition !== i && F.transition("is supported") ? a.transition(x.transition + " out", x.duration, function () {
                            a.remove()
                    ...
                    success: function () {
                        F.removeClass(S.error).addClass(S.success)
                    }, defaults: function () {
                        f.each(function () {
                        ...
                        F.removeClass(S.success).addClass(S.error)
                    }, value: function (e, t) {
                        var n = {};
                        return n[e] = t, O.set.values.call(D, n)
                    }, values: function (t) {
                        e.isEmptyObject(t) || e.each(t, function (t, n) {
                            var i, o = O.get.field(t), a = o.parent(), r = e.isArray(n), s = a.is(k.uiCheckbox), c = a.is(k.uiDropdown), l = o.is(k.radio) && s, u = o.length > 0;
                            ...
                            })) : l ? (O.verbose("Selecting radio value", n, o), o.filter('[value="' + n + '"]').parent(k.uiCheckbox).checkbox("check")) : s ? (O.verbose("Setting checkbox value", n, a), a.checkbox(n === !0 ? "check" : "uncheck")) : c ? (O.verbose("Setting dropdown value", n, a), a.dropdown("set selected", n)) : (O.verbose("Setting field value", n, o), o.val(n)))
                        })
                    }
                }, validate: {
                    form: function (e) {
                        return j ? !1 : (q = [], O.is.valid() ? (O.debug("Form has no validation errors, submitting"), O.set.success(), x.onSuccess.call(D, e)) : (O.debug("Form has errors"), O.set.error(), x.inline || O.add.errors(q), F.data("moduleApi") !== i && e.stopImmediatePropagation(), x.onFailure.call(D, q)))
                    }, field: function (t) {
                        var n = O.get.field(t.identifier), o = !0, a = [];
                        return n.prop("disabled") ? (O.debug("Field is disabled. Skipping", t.identifier), o = !0) : t.optional && "" === e.trim(n.val()) ? (O.debug("Field is optional and empty. Skipping", t.identifier), o = !0) : t.rules !== i && e.each(t.rules, function (e, n) {
                            O.has.field(t.identifier) && !O.validate.rule(t, n) && (O.debug("Field is invalid", t.identifier, n.type), a.push(n.prompt), o = !1)
                        }), o ? (O.remove.prompt(t, a), x.onValid.call(n), !0) : (q = q.concat(a), O.add.prompt(t.identifier, a), x.onInvalid.call(n, a), !1)
                    }, rule: function (t, n) {
                        var i, o, a, r = O.get.field(t.identifier), s = n.type, c = r.val(), l = s.match(x.regExp.bracket), u = !0;
                        if (c = e.trim(r.val() + ""), l) {
                            if (o = "" + l[1], a = s.replace(l[0], ""), i = x.rules[a], !e.isFunction(i))return void O.error(T.noRule, a);
                            u = i.call(r, c, o)
                        } else {
                            if (i = x.rules[s], !e.isFunction(i))return void O.error(T.noRule, s);
                            u = i.call(r, c)
                        }
                        return u
                    }
                    ...
                    x.debug && (x.performance ? O.performance.log(arguments) : (O.debug = Function.prototype.bind.call(console.info, console, x.name + ":"), O.debug.apply(console, arguments)))
                }, verbose: function () {
                    x.verbose && x.debug && (x.performance ? O.performance.log(arguments) : (O.verbose = Function.prototype.bind.call(console.info, console, x.name + ":"), O.verbose.apply(console, arguments)))
                }, error: function () {
                    O.error = Function.prototype.bind.call(console.error, console, x.name + ":"), O.error.apply(console, arguments)
                }, performance: {
                    log: function (e) {
                        var t, n, i;
                        ...
                        var t = x.name + ":", n = 0;
                        s = !1, clearTimeout(O.performance.timer), e.each(c, function (e, t) {
                            n += t["Execution Time"]
                    ...
                    var r, s, c, l = E;
                    return n = n || m, a = D || a, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
        ...
        rules: {
            checked: function () {
                ...
                return e('[data-validate="' + n + '"]').length > 0 ? o = e('[data-validate="' + n + '"]').val() : e("#" + n).length > 0 ? o = e("#" + n).val() : e('[name="' + n + '"]').length > 0 ? o = e('[name="' + n + '"]').val() : e('[name="' + n + '[]"]').length > 0 && (o = e('[name="' + n + '[]"]')), o !== i ? t.toString() == o.toString() : !1
            }, maxCount: function (t, n) {
                return t = t.split(","), e.isArray(t) && t.length <= n
            }, exactCount: function (t, n) {
                return t = t.split(","), e.isArray(t) && t.length == n
            }, minCount: function (t, n) {
                return t = t.split(","), e.isArray(t) && t.length >= n
            }, regExp: function (t, n) {
    ...
    e.fn.accordion = function (n) {
        ...
        return a.each(function () {
            ...
            m = {
                initialize: function () {
                    m.debug("Initializing", C), m.bind.events(), m.observeChanges(), m.instantiate()
                }, instantiate: function () {
                    T = m, C.data(y, m)
                }, destroy: function () {
    ...
    e.fn.checkbox = function (n) {
        ...
        return a.each(function () {
            var a, m, f = e.extend(!0, {}, e.fn.checkbox.settings, n), g = f.className, p = f.namespace, v = f.selector, h = f.error, b = "." + p, y = "module-" + p, x = e(this), C = e(this).children(v.label), w = e(this).children(v.input), k = x.data(y), S = this;
            m = {
                initialize: function () {
                    ...
                    m.is.indeterminate() ? (m.debug("Initial value is indeterminate"), m.set.indeterminate(), f.fireOnInit && (f.onIndeterminate.call(w[0]), f.onChange.call(w[0]))) : m.is.checked() ? (m.debug("Initial value is checked"), m.set.checked(), f.fireOnInit && (f.onChecked.call(w[0]), f.onChange.call(w[0]))) : (m.debug("Initial value is unchecked"), m.set.unchecked(), f.fireOnInit && (f.onUnchecked.call(w[0]), f.onChange.call(w[0])))
                }, refresh: function () {
                    C = x.children(v.label), w = x.children(v.input)
                }, hide: {
                    input: function () {
                        m.verbose("Modfying <input> z-index to be unselectable"), w.addClass(g.hidden)
                    }
                }, show: {
                    input: function () {
                        m.verbose("Modfying <input> z-index to be selectable"), w.removeClass(g.hidden)
                    }
                }, observeChanges: function () {
                    "MutationObserver"in t && (a = new MutationObserver(function (e) {
                        m.debug("DOM tree modified, updating selector cache"), m.refresh()
                    }), a.observe(S, {childList: !0, subtree: !0}), m.debug("Setting up mutation observer", a))
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    ...
                    click: function (t) {
                        return e(t.target).is(v.input) ? void m.verbose("Using default check action on initialized checkbox") : (m.toggle(), void t.preventDefault())
                    }, keydown: function (e) {
                        var t = e.which, n = {enter: 13, space: 32, escape: 27};
                        t == n.escape && (m.verbose("Escape key pressed blurring field"), w.blur(), e.preventDefault()), e.ctrlKey || t != n.enter && t != n.space || (m.verbose("Enter key pressed, toggling checkbox"), m.toggle(), e.preventDefault())
                    }
                }, check: function () {
                    return !m.is.indeterminate() && m.is.checked() ? void m.debug("Checkbox is already checked") : (m.debug("Checking checkbox", w), m.set.checked(), f.onChecked.call(w[0]), void f.onChange.call(w[0]))
                }, uncheck: function () {
                    return !m.is.indeterminate() && m.is.unchecked() ? void m.debug("Checkbox is already unchecked") : (m.debug("Unchecking checkbox"), m.set.unchecked(), f.onUnchecked.call(w[0]), void f.onChange.call(w[0]))
                }, indeterminate: function () {
                    return m.is.indeterminate() ? void m.debug("Checkbox is already indeterminate") : (m.debug("Making checkbox indeterminate"), m.set.indeterminate(), f.onIndeterminate.call(w[0]), void f.onChange.call(w[0]))
                }, determinate: function () {
                    return m.is.determinate() ? void m.debug("Checkbox is already determinate") : (m.debug("Making checkbox determinate"), m.set.determinate(), f.onDeterminate.call(w[0]), void f.onChange.call(w[0]))
                }, enable: function () {
                    return m.is.enabled() ? void m.debug("Checkbox is already enabled") : (m.debug("Enabling checkbox"), m.set.enabled(), void f.onEnable.call(w[0]))
                }, disable: function () {
                    return m.is.disabled() ? void m.debug("Checkbox is already disabled") : (m.debug("Disabling checkbox"), m.set.disabled(), void f.onDisable.call(w[0]))
                }, get: {
                    radios: function () {
                        var t = m.get.name();
                    ...
                    checked: function () {
                        return m.verbose("Setting class to checked"), x.removeClass(g.indeterminate).addClass(g.checked), m.is.radio() && m.uncheckOthers(),
                            !m.is.indeterminate() && m.is.checked() ? void m.debug("Input is already checked, skipping input property change") : (m.verbose("Setting state to checked", w[0]), w.prop("indeterminate", !1).prop("checked", !0), void m.trigger.change())
                    }, unchecked: function () {
                        return m.verbose("Removing checked class"), x.removeClass(g.indeterminate).removeClass(g.checked), !m.is.indeterminate() && m.is.unchecked() ? void m.debug("Input is already unchecked") : (m.debug("Setting state to unchecked"), w.prop("indeterminate", !1).prop("checked", !1), void m.trigger.change())
                    }, indeterminate: function () {
                        return m.verbose("Setting class to indeterminate"), x.addClass(g.indeterminate), m.is.indeterminate() ? void m.debug("Input is already indeterminate, skipping input property change") : (m.debug("Setting state to indeterminate"), w.prop("indeterminate", !0), void m.trigger.change())
                    }, determinate: function () {
                        return m.verbose("Removing indeterminate class"), x.removeClass(g.indeterminate), m.is.determinate() ? void m.debug("Input is already determinate, skipping input property change") : (m.debug("Setting state to determinate"), void w.prop("indeterminate", !1))
                    }, disabled: function () {
                        return m.verbose("Setting class to disabled"), x.addClass(g.disabled), m.is.disabled() ? void m.debug("Input is already disabled, skipping input property change") : (m.debug("Setting state to disabled"), w.prop("disabled", "disabled"), void m.trigger.change())
                    }, enabled: function () {
                        return m.verbose("Removing disabled class"), x.removeClass(g.disabled), m.is.enabled() ? void m.debug("Input is already enabled, skipping input property change") : (m.debug("Setting state to enabled"), w.prop("disabled", !1), void m.trigger.change())
                    }, tabbable: function () {
                        m.verbose("Adding tabindex to checkbox"), w.attr("tabindex") === i && w.attr("tabindex", 0)
                    }
                }, trigger: {
                    change: function () {
                        m.verbose("Triggering change event from programmatic change"), w.trigger("change")
                    }
                }, create: {
                    label: function () {
                        w.prevAll(v.label).length > 0 ? (w.prev(v.label).detach().insertAfter(w), m.debug("Moving existing label", C)) : m.has.label() || (C = e("<label>").insertAfter(w), m.debug("Creating label", C))
                    }
                }, has: {
                    label: function () {
                        return C.length > 0
                    ...
                    events: function () {
                        m.verbose("Attaching checkbox events"), x.on("click" + b, m.event.click).on("keydown" + b, v.input, m.event.keydown)
                    }
                }, unbind: {
                    events: function () {
            ...
            }, u ? (k === i && m.initialize(), m.invoke(l)) : (k !== i && k.invoke("destroy"), m.initialize())
        }), o !== i ? o : this
        ...
        error: {method: "The method you called is not defined"},
        selector: {checkbox: ".ui.checkbox", label: "label, .box", input: 'input[type="checkbox"], input[type="radio"]'}
    }
}(jQuery, window, document), function (e, t, n, i) {
    "use strict";
    ...
    e.fn.dropdown = function (o) {
        ...
        return r.each(function (p) {
            var v, h, b, y, x, C, w, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings), S = k.className, T = k.message, A = k.metadata, R = k.namespace, P = k.regExp, E = k.selector, O = k.error, F = k.templates, D = "." + R, q = "module-" + R, j = e(this), z = e(k.context), I = j.find(E.text), N = j.find(E.search), L = j.find(E.input), H = j.find(E.icon), V = j.prev().find(E.text).length > 0 ? j.prev().find(E.text) : j.prev(), M = j.children(E.menu), U = M.find(E.item), W = !1, B = !1, Q = this, X = j.data(q);
            w = {
                initialize: function () {
                    w.debug("Initializing dropdown", k), w.is.alreadySetup() ? w.setup.reference() : (w.setup.layout(), w.refreshData(), w.save.defaults(), w.restore.selected(), w.create.id(), l && w.bind.touchEvents(), w.bind.mouseEvents(), w.bind.keyboardEvents(), w.observeChanges(), w.instantiate())
                }, instantiate: function () {
                    w.verbose("Storing instance of dropdown", w), X = w, j.data(q, w)
                }, destroy: function () {
                    w.verbose("Destroying previous dropdown", j), w.remove.tabbable(), j.off(D).removeData(q), M.off(D), s.off(b), x && x.disconnect(), C && C.disconnect()
                }, observeChanges: function () {
                    ...
                    id: function () {
                        ...
                        return (t = t || w.get.userValues()) ? (t = e.isArray(t) ? t : [t], e.each(t, function (t, r) {
                            w.get.item(r) === !1 && (a = k.templates.addition(r), o = e("<div />").html(a).data(A.value, r).addClass(S.addition).addClass(S.item), n = n === i ? o : n.add(o), w.verbose("Creating user choices for value", r, o))
                        }), n) : !1
                    ...
                    firstUnfiltered: function () {
                        w.verbose("Selecting first non-filtered element"), w.remove.selectedItem(), U.not(E.unselectable).eq(0).addClass(S.selected)
                    }, nextAvailable: function (e) {
                        e = e.eq(0);
                        var t = e.nextAll(E.item).not(E.unselectable).eq(0), n = e.prevAll(E.item).not(E.unselectable).eq(0), i = t.length > 0;
                    ...
                    api: function () {
                        ...
                        w.verbose("First request, initializing API"), j.api(e)
                    }, layout: function () {
                        j.is("select") && (w.setup.select(), w.setup.returnedObject()), w.is.search() && !w.has.search() && (w.verbose("Adding search input"), N = e("<input />").addClass(S.search).insertBefore(I)), k.allowTab && w.set.tabbable(), 0 === M.length && (M = e("<div />").addClass(S.menu).appendTo(j))
                    }, select: function () {
                        var t = w.get.selectValues();
                        w.debug("Dropdown initialized on a select", t), j.is("select") && (L = j), L.parent(E.dropdown).length > 0 ? (w.debug("UI dropdown already exists. Creating dropdown menu only"), j = L.closest(E.dropdown), M = j.children(E.menu), w.setup.menu(t)) : (w.debug("Creating entire dropdown from select"), j = e("<div />").attr("class", L.attr("class")).addClass(S.selection).addClass(S.dropdown).html(F.dropdown(t)).insertBefore(L), L.removeAttr("class").detach().prependTo(j)), L.is("[multiple]") && w.set.multiple(), w.refresh()
                    }, menu: function (e) {
                        M.html(F.menu(e)), U = M.find(E.item)
                    }, reference: function () {
                        w.debug("Dropdown behavior was called on select, replacing with closest dropdown"), j = j.parent(E.dropdown), w.refresh(), w.setup.returnedObject(), f && (X = w, w.invoke(m))
                    ...
                    w.verbose("Refreshing selector cache"), I = j.find(E.text), N = j.find(E.search), L = j.find(E.input), H = j.find(E.icon), V = j.prev().find(E.text).length > 0 ? j.prev().find(E.text) : j.prev(), M = j.children(E.menu), U = M.find(E.item)
                }, refreshData: function () {
                    w.verbose("Refreshing cached metadata"), U.removeData(A.text).removeData(A.value), j.removeData(A.defaultText).removeData(A.defaultValue).removeData(A.placeholderText)
                }, toggle: function () {
                    ...
                    if (t = e.isFunction(t) ? t : function () {
                        ...
                        w.animate.show(function () {
                            w.can.click() && w.bind.intent(), w.set.visible(), t.call(Q)
                        }), k.onShow.call(Q)
                    }
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, w.is.active() && (w.debug("Hiding dropdown"), w.animate.hide(function () {
                        w.remove.visible(), t.call(Q)
                    }), k.onHide.call(Q))
                }, hideOthers: function () {
                    w.verbose("Finding other dropdowns to hide"), r.not(j).has(E.menu + "." + S.visible).dropdown("hide")
                }, hideMenu: function () {
                    w.verbose("Hiding menu  instantaneously"), w.remove.active(), w.remove.visible(), M.transition("hide")
                }, hideSubMenus: function () {
                    var e = M.children(E.item).find(E.menu);
                    w.verbose("Hiding sub menus", e), e.transition("hide")
                }, bind: {
                    keyboardEvents: function () {
                        w.debug("Binding keyboard events"), j.on("keydown" + D, w.event.keydown), w.has.search() && j.on(w.get.inputEvent() + D, E.search, w.event.input), w.is.multiple() && s.on("keydown" + b, w.event.document.keydown)
                    }, touchEvents: function () {
                        w.debug("Touch device detected binding additional touch events"), w.is.searchSelection() || w.is.single() && j.on("touchstart" + D, w.event.test.toggle), M.on("touchstart" + D, E.item, w.event.item.mouseenter)
                    }, mouseEvents: function () {
                        w.debug("Mouse detected binding mouse events"), w.is.multiple() && j.on("click" + D, E.label, w.event.label.click).on("click" + D, E.remove, w.event.remove.click), w.is.searchSelection() ? (j.on("mousedown" + D, E.menu, w.event.menu.mousedown).on("mouseup" + D, E.menu, w.event.menu.mouseup).on("click" + D, E.icon, w.event.icon.click).on("click" + D, E.search, w.show).on("focus" + D, E.search, w.event.search.focus).on("blur" + D, E.search, w.event.search.blur).on("click" + D, E.text, w.event.text.focus), w.is.multiple() && j.on("click" + D, w.event.click)) : ("click" == k.on ? j.on("click" + D, E.icon, w.event.icon.click).on("click" + D, w.event.test.toggle) : "hover" == k.on ? j.on("mouseenter" + D, w.delay.show).on("mouseleave" + D, w.delay.hide) : j.on(k.on + D, w.toggle), j.on("mousedown" + D, w.event.mousedown).on("mouseup" + D, w.event.mouseup).on("focus" + D, w.event.focus).on("blur" + D, w.event.blur)), M.on("mouseenter" + D, E.item, w.event.item.mouseenter).on("mouseleave" + D, E.item, w.event.item.mouseleave).on("click" + D, E.item, w.event.item.click)
                    }, intent: function () {
                    ...
                    w.has.maxSelections() || (k.apiSettings ? w.can.useAPI() ? w.queryRemote(t, function () {
                        n()
                    ...
                    j.api("get request") || w.setup.api(), i = e.extend(!0, {}, i, k.apiSettings), j.api("setting", i).api("query")
                }, filterItems: function (t) {
                    var n = t !== i ? t : w.get.query(), o = e(), a = w.escape.regExp(n), r = new RegExp("^" + a, "igm");
                    "" === n ? o = U : (w.verbose("Searching for matching values", n), U.each(function () {
                        var t, i, a = e(this);
                        if ("both" == k.match || "text" == k.match) {
                            if (t = String(w.get.choiceText(a, !1)), -1 !== t.search(r))return o = o.add(a), !0;
                            if (k.fullTextSearch && w.fuzzySearch(n, t))return o = o.add(a), !0
                        }
                        if ("both" == k.match || "value" == k.match) {
                            if (i = String(w.get.choiceValue(a, t)), -1 !== i.search(r))return o = o.add(a), !0;
                            if (k.fullTextSearch && w.fuzzySearch(n, i))return o = o.add(a), !0
                        }
                    })), w.debug("Showing only matched items", n), w.remove.filteredItem(), U.not(o).addClass(S.filtered)
                    ...
                    w.is.search() && !w.is.focusedOnSearch() && N[0].focus()
                }, forceSelection: function () {
                    var e = U.not(S.filtered).filter("." + S.selected).eq(0), t = U.not(S.filtered).filter("." + S.active).eq(0), n = e.length > 0 ? e : t, i = n.size() > 0;
                    i ? (w.debug("Forcing partial selection to selected item", n), w.event.item.click.call(n)) : w.hide()
                }, event: {
                    focus: function () {
                        k.showOnFocus && !W && w.is.hidden() && !h && w.show()
                    }, click: function (t) {
                        var n = e(t.target);
                        n.is(j) && !w.is.focusedOnSearch() && w.focusSearch()
                    }, blur: function (e) {
                        h = n.activeElement === this, W || h || (w.remove.activeLabel(), w.hide())
                    }, mousedown: function () {
                        W = !0
                    }, mouseup: function () {
                        W = !1
                        ...
                        focus: function () {
                            W = !0, w.is.multiple() && w.remove.activeLabel(), k.showOnFocus && w.show()
                        }, blur: function (e) {
                            h = n.activeElement === this, B || h || (w.is.multiple() ? (w.remove.activeLabel(), w.hide()) : k.forceSelection ? w.forceSelection() : w.hide())
                        }
                    }, icon: {
                        click: function (e) {
                        ...
                        click: function (t) {
                            var n = e(this), i = j.find(E.label), o = i.filter("." + S.active), a = n.nextAll("." + S.active), r = n.prevAll("." + S.active), s = a.length > 0 ? n.nextUntil(a).add(o).add(n) : n.prevUntil(r).add(o).add(n);
                        ...
                        toggle: function (e) {
                            ...
                            w.determine.eventOnElement(e, function () {
                                "touchstart" == e.type ? w.timer = setTimeout(w.hide, k.delay.touch) : "touchmove" == e.type && clearTimeout(w.timer)
                            }), e.stopPropagation()
                        }, hide: function (e) {
                        ...
                        mouseenter: function (t) {
                            var n = e(this).children(E.menu), i = e(this).siblings(E.item).children(E.menu);
                            ...
                            if( n.length > 0 ) {
                                ...
                                w.itemTimer = setTimeout(function() {
                                    ...
                                    $.each(i, function() {
                                        w.animate.hide(false, e(this));
                                    });
                                    w.animate.show(false,  n);
                                }, k.delay.show);
//                                t.preventDefault();
                            }

                        }, mouseleave: function (t) {
                            var n = e(this).children(E.menu);
                            n.length > 0 && (clearTimeout(w.itemTimer), w.itemTimer = setTimeout(function () {
                                w.verbose("Hiding sub-menu", n), w.animate.hide(!1, n)
                            }, k.delay.hide))
                        }, click: function (t) {
                            var n = e(this), i = e(t ? t.target : ""), o = n.find(E.menu), a = w.get.choiceText(n), r = w.get.choiceValue(n, a), s = o.length > 0, c = o.find(i).length > 0;
                        ...
                        keydown: function (e) {
                            ...
                            if (i) {
                                var o = j.find(E.label), a = o.filter("." + S.active), r = (a.data("value"), o.index(a)), s = o.length, c = a.length > 0, l = a.length > 1, u = 0 === r, d = r + 1 == s, m = w.is.searchSelection(), f = w.is.focusedOnSearch(), g = w.is.focused(), p = f && 0 === w.get.caretPosition();
                                if (m && !c && !f)return;
                        ...
                        var t = e.which, n = w.get.shortcutKeys(), i = w.is.inObject(t, n);
                        if (i) {
                            var o, a, r = U.not(E.unselectable).filter("." + S.selected).eq(0), s = M.children("." + S.active).eq(0), c = r.length > 0 ? r : s, l = c.length > 0 ? c.siblings(":not(." + S.filtered + ")").andSelf() : M.children(":not(." + S.filtered + ")"), u = c.children(E.menu), d = c.closest(E.menu), m = d.hasClass(S.visible) || d.hasClass(S.animating) || d.parent(E.menu).length > 0, f = u.length > 0, g = c.length > 0, p = c.not(E.unselectable).length > 0;
                            if (w.is.visible()) {
                                if ((t == n.enter || t == n.delimiter) && (t == n.enter && g && f && !k.allowCategorySelection ? (w.verbose("Pressed enter on unselectable category, opening sub menu"), t = n.rightArrow) : p && (w.verbose("Selecting item from keyboard shortcut", c), w.event.item.click.call(c, e), w.is.searchSelection() && w.remove.searchTerm()), e.preventDefault()), t == n.leftArrow && (a = d[0] !== M[0], a && (w.verbose("Left key pressed, closing sub-menu"), w.animate.hide(!1, d), c.removeClass(S.selected), d.closest(E.item).addClass(S.selected), e.preventDefault())), t == n.rightArrow && f && (w.verbose("Right key pressed, opening sub-menu"), w.animate.show(!1, u), c.removeClass(S.selected), u.find(E.item).eq(0).addClass(S.selected), e.preventDefault()), t == n.upArrow) {
                                    if (o = g && m ? c.prevAll(E.item + ":not(" + E.unselectable + ")").eq(0) : U.eq(0), l.index(o) < 0)return w.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                    w.verbose("Up key pressed, changing active item"), c.removeClass(S.selected), o.addClass(S.selected), w.set.scrollPosition(o), e.preventDefault()
                                }
                                if (t == n.downArrow) {
                                    if (o = g && m ? o = c.nextAll(E.item + ":not(" + E.unselectable + ")").eq(0) : U.eq(0), 0 === o.length)return w.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                    w.verbose("Down key pressed, changing active item"), U.removeClass(S.selected), o.addClass(S.selected), w.set.scrollPosition(o), e.preventDefault()
                                }
                            ...
                            } else t == n.delimiter && e.preventDefault(), t == n.downArrow && (w.verbose("Down key pressed, showing dropdown"), w.show(), e.preventDefault())
                    ...
                    selectAction: function (t, n) {
                        ...
                        var o = e(t.target), a = o.closest(n.documentElement).length > 0, r = o.closest(j).length > 0;
                        ...
                        var i = e(t.target), o = 0 === i.closest(E.siblingLabel).length, a = 0 === i.closest(M).length;
                        return n = e.isFunction(n) ? n : function () {
                        }, o && a ? (w.verbose("Triggering event", n), n(), !0) : (w.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    }, activate: function (t, n) {
                        n = n !== i ? n : t, w.set.selected(n, e(this)), (!w.is.multiple() || w.is.allFiltered()) && w.hideAndClear()
                    }, select: function (e, t) {
                    ...
                    id: function () {
                        ...
                        return L.length > 0 ? L.val() : j.data(A.value)
                    }, values: function () {
                        var e = w.get.value();
                        return "" === e ? "" : !L.is("select") && w.is.multiple() ? "string" == typeof e ? e.split(k.delimiter) : "" : e
                        ...
                        return t = t !== i ? t : k.preserveHTML, e ? (e.find(E.menu).length > 0 && (w.verbose("Retreiving text of element with sub-menu"), e = e.clone(), e.find(E.menu).remove(), e.find(E.menuIcon).remove()), e.data(A.text) !== i ? e.data(A.text) : t ? e.html().trim() : e.text().trim()) : void 0
                    }, choiceValue: function (e, t) {
                        return t = t || w.get.choiceText(e), e ? e.data(A.value) !== i ? e.data(A.value) : "string" == typeof t ? t.toLowerCase().trim() : t : !1
                    }, inputEvent: function () {
                        var e = N[0];
                        return e ? e.oninput !== i ? "input" : e.onpropertychange !== i ? "propertychange" : "keyup" : !1
                    }, selectValues: function () {
                        var t = {};
                        return t.values = [], j.find("option").each(function () {
                        ...
                        var e = U.not(E.unselectable).filter("." + S.selected);
                        ...
                        var o, a, r = !1;
                        return t = t !== i ? t : w.get.values() !== i ? w.get.values() : w.get.text(), o = a ? t.length > 0 : t !== i && "" !== t && null !== t, a = w.is.multiple() && e.isArray(t), n = "" === t || 0 === t ? !0 : n || !1, o && U.each(function () {
                            var o = e(this), s = w.get.choiceText(o), c = w.get.choiceValue(o, s);
                            if (null !== c && c !== i)if (a)(-1 !== e.inArray(c.toString(), t) || -1 !== e.inArray(s, t)) && (r = r ? r.add(o) : o); else if (n) {
                                if (w.verbose("Ambiguous dropdown value using strict type check", o, t), c === t || s === t)return r = o, !0
                            } else if (c.toString() == t.toString() || s == t)return w.verbose("Found select item by value", c, t), r = o, !0
                        }), r
                    }
                }, check: {
                    maxSelections: function (e) {
                        return k.maxSelections ? (e = e !== i ? e : w.get.selectionCount(), e >= k.maxSelections ? (w.debug("Maximum selection count reached"), U.addClass(S.filtered), w.add.message(T.maxSelections), !0) : (w.verbose("No longer at maximum selection count"), w.remove.message(), w.remove.filteredItem(), w.is.searchSelection() && w.filterItems(), !1)) : !0
                    }
                }, restore: {
                    defaults: function () {
                        w.clear(), w.restore.defaultText(), w.restore.defaultValue()
                    }, defaultText: function () {
                        var e = j.data(A.defaultText);
                        w.debug("Restoring default text", e), w.set.text(e), I.addClass(S.placeholder)
                    }, defaultValue: function () {
                        var e = j.data(A.defaultValue);
                    ...
                    defaults: function () {
                        ...
                        var e = w.get.value();
                        w.verbose("Saving default value as", e), j.data(A.defaultValue, e)
                    }, defaultText: function () {
                        var e = w.get.text();
                        w.verbose("Saving default text as", e), j.data(A.defaultText, e)
                    }, placeholderText: function () {
                        var e;
                        I.hasClass(S.placeholder) && (e = w.get.text(), w.verbose("Saving placeholder text as", e), j.data(A.placeholderText, e))
                    ...
                    var n, i, o, t = t || w.get.selectedItem(), a = t.closest(E.menu), r = a.outerHeight(), s = a.scrollTop(), c = U.eq(0).outerHeight(), l = Math.floor(r / c), u = (a.prop("scrollHeight"), "up" == e ? s - c * l : s + c * l), d = U.not(E.unselectable);
                    o = "up" == e ? d.index(t) - l : d.index(t) + l, n = "up" == e ? o >= 0 : o < d.length, i = n ? d.eq(o) : "up" == e ? d.first() : d.last(), i.length > 0 && (w.debug("Scrolling page", e, i), t.removeClass(S.selected), i.addClass(S.selected), a.scrollTop(u))
                }, set: {
                    filtered: function () {
                        ...
                        e && o && (w.verbose("Adjusting input width", a, k.glyphWidth), N.css("width", a)), o || n && r ? (w.verbose("Hiding placeholder text"), I.addClass(S.filtered)) : (!e || n && !r) && (w.verbose("Showing placeholder text"), I.removeClass(S.filtered))
                    }, loading: function () {
                        j.addClass(S.loading)
                    }, placeholderText: function (e) {
                        e = e || j.data(A.placeholderText), e && (w.debug("Restoring placeholder text"), w.set.text(e), I.addClass(S.placeholder))
                    }, tabbable: function () {
                        w.has.search() ? (w.debug("Added tabindex to searchable dropdown"), N.val("").attr("tabindex", 0), M.attr("tabindex", -1)) : (w.debug("Added tabindex to dropdown"), j.attr("tabindex") || (j.attr("tabindex", 0), M.attr("tabindex", -1)))
                    }, initialLoad: function () {
                        w.verbose("Setting initial load"), v = !0
                    }, scrollPosition: function (e, t) {
                        var n, o, a, r, s, c, l, u, d, m = 5;
                        e = e || w.get.selectedItem(), n = e.closest(E.menu), o = e && e.length > 0, t = t !== i ? t : !1, e && n.length > 0 && o && (r = e.position().top, n.addClass(S.loading), c = n.scrollTop(), s = n.offset().top, r = e.offset().top, a = c - s + r, t || (l = n.height(), d = a + m > c + l, u = c > a - m), w.debug("Scrolling to active item", a), (t || u || d) && n.scrollTop(a), n.removeClass(S.loading))
                    }, text: function (e) {
                        "select" !== k.action && ("combo" == k.action ? (w.debug("Changing combo button text", e, V), k.preserveHTML ? V.html(e) : V.text(e)) : (w.debug("Changing text", e, I), I.removeClass(S.filtered).removeClass(S.placeholder), k.preserveHTML ? I.html(e) : I.text(e)))
                    }, selectedLetter: function (t) {
                        var n, i = U.filter("." + S.selected), o = i.length > 0 && w.has.firstLetter(i, t), a = !1;
                        o && (n = i.nextAll(U).eq(0), w.has.firstLetter(n, t) && (a = n)), a || U.each(function () {
                        ...
                        var i = L.length > 0, o = (!w.has.value(e), w.get.values()), a = "number" == typeof e ? e.toString() : e;
                        if (i) {
                            if (a == o && (w.verbose("Skipping value update already same value", e, o), !w.is.initialLoad()))return;
                            L.is("select") && (k.allowAdditions || k.apiSettings) && (w.debug("Adding an option to the select before setting the value", e), w.add.optionValue(e)), w.debug("Updating input value", e, o), L.val(e).trigger("change")
                        } else w.verbose("Storing value in metadata", e, L), e !== o && j.data(A.value, e);
                        k.fireOnInit === !1 && w.is.initialLoad() ? w.verbose("No callback on initial load", k.onChange) : k.onChange.call(Q, e, t, n)
                    }, active: function () {
                        j.addClass(S.active)
                    }, multiple: function () {
                        j.addClass(S.multiple)
                    }, visible: function () {
                        j.addClass(S.visible)
                        ...
                        n = k.allowAdditions ? n || w.get.itemWithAdditions(t) : n || w.get.item(t), n && (w.debug("Setting selected menu item to", n), w.is.single() ? (w.remove.activeItem(), w.remove.selectedItem()) : k.useLabels && w.remove.selectedItem(), n.each(function () {
                            ...
                            i ? !s || c ? (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a), k.useLabels ? (w.add.value(a, o, t), w.add.label(a, o, l), t.addClass(S.active), w.filterActive(), w.select.nextAvailable(n)) : (w.set.text(w.add.variables(T.count)), w.add.value(a, o, t), t.addClass(S.active))) : r || (w.debug("Selected active value, removing label"), w.remove.selected(a)) : (k.apiSettings && k.saveRemoteData && w.save.remoteData(o, a), w.set.text(o), w.set.value(a, o, t), t.addClass(S.active).addClass(S.selected))
                        }))
                    }
                }, add: {
                    label: function (t, n, i) {
                        var o, a = w.is.searchSelection() ? N : I;
                        return o = e("<a />").addClass(S.label).attr("data-value", t).html(F.label(t, n)), o = k.onLabelCreate.call(o, t, n), w.has.label(t) ? void w.debug("Label already exists, skipping", t) : (k.label.variation && o.addClass(k.label.variation), void(i === !0 ? (w.debug("Animating in label", o), o.addClass(S.hidden).insertBefore(a).transition(k.label.transition, k.label.duration)) : (w.debug("Adding selection label", o), o.insertBefore(a))))
                    }, message: function (t) {
                        var n = M.children(E.message), i = k.templates.message(w.add.variables(t));
                        n.length > 0 ? n.html(i) : n = e("<div/>").html(i).addClass(S.message).appendTo(M)
                    }, optionValue: function (t) {
                        var n = L.find('option[value="' + t + '"]'), i = n.length > 0;
                        i || (x && (x.disconnect(), w.verbose("Temporarily disconnecting mutation observer", t)), e("<option/>").prop("value", t).html(t).appendTo(L), w.verbose("Adding user addition as an <option>", t), x && x.observe(L[0], {
                            childList: !0,
                            subtree: !0
                        }))
                    }, userSuggestion: function (e) {
                        var t, n = M.children(E.addition), i = w.get.item(e), o = n.length > 0;
                        if (!w.has.maxSelections()) {
                            if ("" === e || i)return void n.remove();
                            U.removeClass(S.selected), o ? (t = k.templates.addition(e), n.html(t).data(A.value, e).removeClass(S.filtered).addClass(S.selected), w.verbose("Replacing user suggestion with new value", n)) : (n = w.create.userChoice(e), n.prependTo(M).addClass(S.selected), w.verbose("Adding item choice to menu corresponding with user choice addition", n))
                        }
                    }, variables: function (e) {
                        var t, n, i = -1 !== e.search("{count}"), o = -1 !== e.search("{maxCount}"), a = -1 !== e.search("{term}");
                        return w.verbose("Adding templated variables to message", e), i && (t = w.get.selectionCount(), e = e.replace("{count}", t)), o && (t = w.get.selectionCount(), e = e.replace("{maxCount}", k.maxSelections)), a && (n = w.get.query(), e = e.replace("{term}", n)), e
                    }, value: function (t, n, i) {
                        var o, a = w.get.values();
                        return "" === t ? void w.debug("Cannot select blank values from multiselect") : (e.isArray(a) ? (o = a.concat([t]), o = w.get.uniqueArray(o)) : o = [t], L.is("select") ? (k.allowAdditions || k.apiSettings) && (w.debug("Adding value to select", t, o, L), w.add.optionValue(t)) : (o = o.join(k.delimiter), w.debug("Setting hidden input to delimited value", o, L)), k.fireOnInit === !1 && w.is.initialLoad() ? w.verbose("No callback on initial load", k.onAdd) : k.onAdd.call(Q, t, n, i), w.set.value(o, t, n, i), void w.check.maxSelections())
                    }
                }, remove: {
                    active: function () {
                        j.removeClass(S.active)
                    }, activeLabel: function () {
                        j.find(E.label).removeClass(S.active)
                    }, loading: function () {
                        j.removeClass(S.loading)
                    }, initialLoad: function () {
                        v = !1
                    }, upward: function (e) {
                        var t = e || j;
                        ...
                        j.removeClass(S.visible)
                    }, activeItem: function () {
                        U.removeClass(S.active)
                    }, filteredItem: function () {
                        w.has.maxSelections() || (k.useLabels ? U.not("." + S.active).removeClass(S.filtered) : U.removeClass(S.filtered))
                    }, message: function () {
                        M.children(E.message).remove()
                    }, searchTerm: function () {
                        ...
                        return (n = k.allowAdditions ? n || w.get.itemWithAdditions(t) : n || w.get.item(t)) ? void n.each(function () {
                            ...
                            w.is.multiple() ? k.useLabels ? (w.remove.value(i, n, t), w.remove.label(i)) : (w.remove.value(i, n, t), w.set.text(w.add.variables(T.count))) : w.remove.value(i, n, t), t.removeClass(S.filtered).removeClass(S.active), k.useLabels && t.removeClass(S.selected)
                        }) : !1
                    }, selectedItem: function () {
                        U.removeClass(S.selected)
                    }, value: function (e, t, n) {
                        var i, o = L.val();
                        L.is("select") ? (w.verbose("Input is <select> removing selected option", e), i = w.remove.arrayValue(e, o)) : (w.verbose("Removing from delimited values", e), o = o.split(k.delimiter), i = w.remove.arrayValue(e, o), i = i.join(k.delimiter)), k.fireOnInit === !1 && w.is.initialLoad() ? w.verbose("No callback on initial load", k.onRemove) : k.onRemove.call(Q, e, t, n), w.set.value(i, t, n), w.check.maxSelections()
                    }, arrayValue: function (t, n) {
                        return n = e.grep(n, function (e) {
                            return t != e
                        }), w.verbose("Removed value from delimited string", t, n), n
                    }, label: function (e) {
                        var t = j.find(E.label), n = t.filter('[data-value="' + e + '"]'), i = t.length, o = t.index(n) + 1 == i, a = (!w.is.searchSelection() || !w.is.focusedOnSearch()) && o;
                        a ? (w.verbose("Animating and removing label", n), n.transition(k.label.transition, k.label.duration, function () {
                            n.remove()
                        })) : (w.verbose("Removing label", n), n.remove())
                    }, activeLabels: function (e) {
                        e = e || j.find(E.label).filter("." + S.active), w.verbose("Removing active label selections", e), w.remove.labels(e)
                    }, labels: function (t) {
                        t = t || j.find(E.label), w.verbose("Removing labels", t), t.each(function () {
                            var t = e(this).data("value"), n = w.is.userValue(t);
                            n ? (w.remove.value(t), w.remove.label(t)) : w.remove.selected(t)
                        })
                    }, tabbable: function () {
                        w.has.search() ? (w.debug("Searchable dropdown initialized"), N.attr("tabindex", "-1"), M.attr("tabindex", "-1")) : (w.debug("Simple selection dropdown initialized"), j.attr("tabindex", "-1"), M.attr("tabindex", "-1"))
                    }
                }, has: {
                    search: function () {
                        return N.length > 0
                    ...
                    active: function () {
                        return j.hasClass(S.active)
                    }, alreadySetup: function () {
                        return j.is("select") && j.parent(E.dropdown).length > 0 && 0 === j.prev().length
                    }, animating: function (e) {
                        return e ? e.transition && e.transition("is animating") : M.transition && M.transition("is animating")
                    }, disabled: function () {
                        j.hasClass(S.disabled)
                    }, focused: function () {
                        ...
                        return j.hasClass(S.search)
                    }, searchSelection: function () {
                        return w.has.search() && 0 === N.closest(E.menu).length
                    }, selection: function () {
                        return j.hasClass(S.selection)
                        ...
                        return e ? e.hasClass(S.visible) : M.hasClass(S.visible)
                    }
                }, can: {
                    click: function () {
                        return l || "click" == k.on
                    ...
                    show: function (t, n) {
                        var o, a = n || M, r = n ? function () {
                        } : function () {
                            w.hideSubMenus(), w.hideOthers(), w.set.active()
                        };
                        t = e.isFunction(t) ? t : function () {
                        }, w.verbose("Doing menu show animation", a), w.set.direction(n), o = w.get.transition(n), w.is.selection() && w.set.scrollPosition(w.get.selectedItem(), !0), (w.is.hidden(a) || w.is.animating(a)) && ("none" == o ? (r(), a.transition("show"), t.call(Q)) : e.fn.transition !== i && j.transition("is supported") ? a.transition({
                            animation: o + " in",
                            debug: k.debug,
                            verbose: k.verbose,
                            duration: k.duration,
                        ...
                        var o = n || M, a = (n ? .9 * k.duration : k.duration, n ? function () {
                        } : function () {
                            w.can.click() && w.unbind.intent(), w.remove.active()
                        }), r = w.get.transition(n);
                        t = e.isFunction(t) ? t : function () {
                        }, (w.is.visible(o) || w.is.animating(o)) && (w.verbose("Doing menu hide animation", o), "none" == r ? (a(), o.transition("hide"), t.call(Q)) : e.fn.transition !== i && j.transition("is supported") ? o.transition({
                            animation: r + " out",
                            duration: k.duration,
                            debug: k.debug,
                            verbose: k.verbose,
                            ...
                            onStart: a,
                            onComplete: function () {
                                "auto" == k.direction && w.remove.upward(n), t.call(Q)
                            }
                    ...
                    regExp: function (e) {
                        return e = String(e), e.replace(P.escape, "\\$&")
                    }
                }, setting: function (t, n) {
                    ...
                    var r, s, c, l = X;
                    return n = n || g, o = Q || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
            ...
            }, f ? (X === i && w.initialize(), w.invoke(m)) : (X !== i && X.invoke("destroy"), w.initialize())
        }), a !== i ? a : r
    ...
    e.fn.embed = function (n) {
        var o, a = e(this), r = a.selector || "", s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
        return a.each(function () {
            var m, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.embed.settings, n) : e.extend({}, e.fn.embed.settings), g = f.selector, p = f.className, v = f.sources, h = f.error, b = f.metadata, y = f.namespace, x = f.templates, C = "." + y, w = "module-" + y, k = (e(t), e(this)), S = k.find(g.placeholder), T = k.find(g.icon), A = k.find(g.embed), R = this, P = k.data(w);
            m = {
                initialize: function () {
                    m.debug("Initializing embed"), m.determine.autoplay(), m.create(), m.bind.events(), m.instantiate()
                }, instantiate: function () {
                    m.verbose("Storing instance of module", m), P = m, k.data(w, m)
                }, destroy: function () {
                    ...
                    events: function () {
                        m.has.placeholder() && (m.debug("Adding placeholder events"), console.log(k, g.placeholder), k.on("click" + C, g.placeholder, m.createAndShow).on("click" + C, g.icon, m.createAndShow))
                    }
                }, create: function () {
                    ...
                    m.refresh(), t = t || m.get.url(), console.log(t), A = e("<div/>").addClass(p.embed).html(m.generate.embed(t)).appendTo(k), f.onCreate.call(R, t), m.debug("Creating embed object", A)
    ...
    e.fn.modal = function (o) {
        ...
        return r.each(function () {
            var r, h, b, y, x, C, w, k, S, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), A = T.selector, R = T.className, P = T.namespace, E = T.error, O = "." + P, F = "module-" + P, D = e(this), q = e(T.context), j = D.find(A.close), z = this, I = D.data(F);
            S = {
                initialize: function () {
                    ...
                    S.verbose("Destroying previous modal"), D.removeData(F).off(O), s.off(C), j.off(O), q.dimmer("destroy")
                }, observeChanges: function () {
                    ...
                    var i = e(t);
                    n = e.isFunction(S[n]) ? S[n] : S.toggle, i.length > 0 ? (S.debug("Attaching modal events to element", t, n), i.off(O).on("click" + O, n)) : S.error(E.notFound, t)
                }, bind: {
                    events: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                        ...
                        useFailSafe: !0,
                        onComplete: function () {
                            T.onVisible.apply(z), S.add.keyboardShortcuts(), S.save.focus(), S.set.active(), S.set.autofocus(), t()
                        }
                    })) : S.error(E.noTransition))) : S.debug("Modal is already visible")
                }, hideModal: function (t, n) {
                    t = e.isFunction(t) ? t : function () {
                    }, S.debug("Hiding modal"), T.onHide.call(z), (S.is.animating() || S.is.active()) && (T.transition && e.fn.transition !== i && D.transition("is supported") ? (S.remove.active(), D.transition({
                        debug: T.debug,
                    ...
                    keyboardShortcuts: function () {
                        S.verbose("Adding keyboard shortcuts"), c.on("keyup" + O, S.event.keyboard)
                    }
                }, save: {
                    focus: function () {
                    ...
                    active: function () {
                        ...
                        S.verbose("Removing keyboard shortcuts"), c.off("keyup" + O)
                    }, scrolling: function () {
                    ...
                    autofocus: function () {
                        if (T.autofocus) {
                            var e = D.filter(":input").filter(":visible"), t = e.filter("[autofocus]"), n = t.length > 0 ? t.first() : e.first();
                            n.length > 0 && n.focus()
                        }
                    }, clickaway: function () {
                        ...
                        S.verbose("Centering modal on page", S.cache), D.css(S.can.fit() ? {
                            top: "",
    ...
    e.fn.popup = function (o) {
        var a, r = e(this), s = e(n), c = e(t), l = e("body"), u = r.selector || "", d = "ontouchstart"in n.documentElement, m = (new Date).getTime(), f = [], g = arguments[0], p = "string" == typeof g, v = [].slice.call(arguments, 1);
        return r.each(function () {
            var n, r, h, b, y, x = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings), C = x.selector, w = x.className, k = x.error, S = x.metadata, T = x.namespace, A = "." + x.namespace, R = "module-" + T, P = e(this), E = e(x.context), O = x.target ? e(x.target) : P, F = 0, D = !1, q = !1, j = this, z = P.data(R);
            y = {
                initialize: function () {
                    ...
                    x.popup ? n = e(x.popup).eq(0) : x.inline && (n = O.next(C.popup).eq(0), x.popup = n), x.popup ? (n.addClass(w.loading), r = y.get.offsetParent(), n.removeClass(w.loading), x.movePopup && y.has.popup() && y.get.offsetParent(n)[0] !== r[0] && (y.debug("Moving popup to the same offset parent as activating element"), n.detach().appendTo(r))) : r = x.inline ? y.get.offsetParent(O) : y.has.popup() ? y.get.offsetParent(n) : l, r.is("html") && (y.debug("Setting page as offset parent"), r = l)
                }, reposition: function () {
                    ...
                    start: function (t) {
                        ...
                        clearTimeout(y.hideTimer), y.showTimer = setTimeout(y.show, n)
                    }, end: function () {
                    ...
                    var t = y.get.html(), i = y.get.variation(), o = y.get.title(), a = y.get.content();
                    t || a || o ? (y.debug("Creating pop-up html"), t || (t = x.templates.popup({
                        title: o,
                        content: a
                    ...
                    y.debug("Removing popup", n), y.has.popup() && !x.popup && (n.remove(), n = i), x.onRemove.call(n, j)
                }, save: {
                    conditions: function () {
                    ...
                    show: function (t) {
                        t = e.isFunction(t) ? t : function () {
                        }, x.transition && e.fn.transition !== i && P.transition("is supported") ? (y.set.visible(), n.transition({
                        ...
                        }, y.debug("Hiding pop-up"), x.onShow.call(n, j) === !1 ? void y.debug("onShow callback returned false, cancelling popup animation") : void(x.transition && e.fn.transition !== i && P.transition("is supported") ? n.transition({
                    ...
                    html: function () {
                        ...
                        var e, i = O[0], o = x.inline || x.popup ? O.position() : O.offset(), a = {};
                        return a = {
                            target: {
                                element: O[0],
                                width: O.outerWidth(),
                        ...
                        }, a.target.margin.top = x.inline ? parseInt(t.getComputedStyle(i).getPropertyValue("margin-top"), 10) : 0, a.target.margin.left = x.inline ? y.is.rtl() ? parseInt(t.getComputedStyle(i).getPropertyValue("margin-right"), 10) : parseInt(t.getComputedStyle(i).getPropertyValue("margin-left"), 10) : 0, e = a.screen, a.boundary = {
                            top: e.scroll.top,
                        ...
                        var n = t !== i ? t[0] : P[0], o = n.parentNode, a = e(o);
                    ...
                    }, offstagePosition: function (t, i) {
                        var o, a, r = n.offset(), s = {}, c = [];
                        return t = t || !1, i = i || y.get.calculations(), o = i.popup, a = i.boundary, r && t && (s = {
                            top: r.top < a.top,
                            bottom: r.top + o.height > a.bottom,
                            right: r.left + o.width > a.right,
                            left: r.left < a.left
                        }, y.verbose("Offstage positions determined", r, s)), e.each(s, function (e, t) {
                            t && c.push(e)
                        }), c.length > 0 ? c.join(" ") : !1
                    }, positions: function () {
                        return {
                    ...
                    position: function (e, t) {
                        ...
                        }), y.debug("RTL: Popup position updated", e)), F == x.maxSearchDepth && x.lastResort && (y.debug('Using "last resort" position to display', x.lastResort), e = x.lastResort), e) {
                            case"top left":
                        ...
                        if (l === i && y.error(k.invalidPosition, e), y.debug("Calculated popup positioning values", l), n.css(l).removeClass(w.position).addClass(e).addClass(w.loading), u = y.get.offstagePosition(e, t)) {
                            if (y.debug("Popup cant fit into viewport", e, u), F < x.maxSearchDepth)return F++, e = y.get.nextPosition(e), y.debug("Trying new position", e), n ? y.set.position(e, t) : !1;
                            if (!x.lastResort)return y.debug("Popup could not find a position in view", n), y.remove.attempts(), y.remove.loading(), y.reset(), !1
                        }
                        return y.debug("Position is on stage", e), y.remove.attempts(), y.set.fluidWidth(t), y.remove.loading(), !0
                    }, fluidWidth: function (e) {
                        e = e || y.get.calculations(), x.setFluidWidth && n.hasClass(w.fluid) && n.css("width", e.parent.width)
                    }, visible: function () {
                    ...
                    loading: function () {
                        ...
                        y.verbose("Resetting all searched positions"), F = 0, D = !1
                    }
                }, bind: {
                    events: function () {
                        y.debug("Binding popup events to module"), "click" == x.on && P.on("click" + A, y.toggle), "hover" == x.on && d ? P.on("touchstart" + A, y.event.touchstart) : y.get.startEvent() && P.on(y.get.startEvent() + A, y.event.start).on(y.get.endEvent() + A, y.event.end), x.target && y.debug("Target set to element", O), c.on("resize" + h, y.event.resize)
                    }, popup: function () {
                ...
                initialize: function () {
                    ...
                    input: function () {
                        ...
                        mousedown: function () {
                            ...
                            var i = e(this), o = i.find(b.title).eq(0), a = i.find("a[href]").eq(0), r = a.attr("href") || !1, s = a.attr("target") || !1, c = (o.html(), o.length > 0 ? o.text() : !1), l = f.get.results(), u = i.data(v.result) || f.get.result(c, l);
                            return e.isFunction(g.onSelect) && g.onSelect.call(R, u, l) === !1 ? void f.debug("Custom onSelect callback cancelled default select action") : (f.hideResults(), c && f.set.value(c), void(r && (f.verbose("Opening search link found in result", a), "_blank" == s || n.ctrlKey ? t.open(r) : t.location.href = r)))
                        }
                    }
                    ...
                    if (r == s.escape && (f.verbose("Escape key pressed, blurring search field"), S.trigger("blur")), f.is.visible())if (r == s.enter) {
                    ...
                    api: function () {
                        ...
                        f.verbose("First request, initializing API"), k.api(e)
                    }
                }, can: {
                    useAPI: function () {
                        return e.fn.api !== i
                    ...
                    inputEvent: function () {
                        var e = S[0], t = e !== i && e.oninput !== i ? "input" : e !== i && e.onpropertychange !== i ? "propertychange" : "keyup";
                        return t
                    }, value: function () {
                        return S.val()
                    }, results: function () {
                    ...
                    loading: function () {
                        ...
                        T.removeClass(p.pressed)
                    }
                }, query: function () {
                    var t = f.get.value(), n = f.read.cache(t);
                    f.has.minimumCharacters() ? n ? (f.debug("Reading result from cache", t), f.save.results(n.results), f.addResults(n.html), f.inject.id(n.results)) : (f.debug("Querying for", t), e.isPlainObject(g.source) || e.isArray(g.source) ? f.search.local(t) : f.can.useAPI() ? f.search.remote(t) : f.error(y.source), g.onSearchQuery.call(R, t)) : f.hideResults()
                }, search: {
                    local: function (e) {
                        ...
                        var n = {
                            onSuccess: function (e) {
                                f.parse.response.call(R, e, t)
                            }, onFailure: function () {
                                f.displayMessage(y.serverError)
                            }, urlData: {query: t}
                        };
                        k.api("get request") || f.setup.api(), e.extend(!0, n, g.apiSettings), f.debug("Executing search", n), f.cancel.query(), k.api("setting", n).api("query")
                        ...
                        return n = n || g.source, o = o !== i ? o : g.searchFields, e.isArray(o) || (o = [o]), n === i || n === !1 ? (f.error(y.source), []) : (e.each(o, function (i, o) {
                    ...
                    response: function (e, t) {
                        ...
                        f.verbose("Parsing server response", e), e !== i && t !== i && e.results !== i && (f.addResults(n), f.inject.id(e.results), f.write.cache(t, {
                            html: n,
                            results: e.results
                        }), f.save.results(e.results))
                    }
                }, cancel: {
                    query: function () {
                    ...
                    id: function (e, t) {
                        ...
                        0 === A.length && (A = e("<div />").addClass(p.results).appendTo(k))
                    }
                }, inject: {
                    result: function (e, t, n) {
                        f.verbose("Injecting result into results");
                        var o = n !== i ? A.children().eq(n).children(b.result).eq(t) : A.children(b.result).eq(t);
                    ...
                    cache: function (e, t) {
                        ...
                        g.cache && (f.verbose("Writing generated html to cache", e, t), n[e] = t, k.data(v.cache, n))
                    }
                    ...
                    return i || o ? (g.maxResults > 0 && (i ? "standard" == g.type && f.error(y.maxResults) : t.results = t.results.slice(0, g.maxResults)), e.isFunction(n) ? a = n(t) : f.error(y.noTemplate, !1)) : a = f.displayMessage(y.noResults, "empty"), g.onResults.call(R, t), a
    ...
    e.fn.shape = function (o) {
        ...
        return r.each(function () {
            var t, f, g, p = r.selector || "", v = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.shape.settings, o) : e.extend({}, e.fn.shape.settings), h = v.namespace, b = v.selector, y = v.error, x = v.className, C = "." + h, w = "module-" + h, k = e(this), S = k.find(b.sides), T = k.find(b.side), A = !1, R = this, P = k.data(w);
            g = {
                initialize: function () {
    ...
    e.fn.sidebar = function (o) {
        ...
        return r.each(function () {
            var r, b, y, x, C, w, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), S = k.selector, T = k.className, A = k.namespace, R = k.regExp, P = k.error, E = "." + A, O = "module-" + A, F = e(this), D = e(k.context), q = F.children(S.sidebar), j = D.children(S.fixed), z = D.children(S.pusher), I = this, N = F.data(O);
            w = {
                initialize: function () {
                    ...
                    w.verbose("Storing instance of module", w), N = w, F.data(O, w)
                }, create: {
                    id: function () {
                        y = (Math.random().toString(16) + "000000000").substr(2, 8), b = "." + y, w.verbose("Creating unique id for element", y)
                    }
                }, destroy: function () {
                    w.verbose("Destroying previous module for", F), w.remove.direction(), F.off(E).removeData(O), w.is.ios() && w.remove.ios(), D.off(b), s.off(b), c.off(b)
                }, event: {
                    ...
                    inlineCSS: function () {
                        var t, n = w.cache.width || F.outerWidth(), i = w.cache.height || F.outerHeight(), o = w.is.rtl(), a = w.get.direction(), s = {
                            left: n,
                            right: -n,
                            top: i,
                            bottom: -i
                    ...
                    var t = q.not(F).filter("." + T.visible), n = t.length, i = 0;
                    e = e || function () {
                    ...
                    var n, i, o, a = w.get.transition(), r = "overlay" === a || w.othersActive() ? F : z;
                    t = e.isFunction(t) ? t : function () {
                    ...
                    var n, i, o = w.get.transition(), a = "overlay" == o || w.othersActive() ? F : z;
                    t = e.isFunction(t) ? t : function () {
                    ...
                    return n = n || v, o = I || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        ...
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
                            if (!e.isPlainObject(l[o]) || n == r)return l[o] !== i ? (s = l[o], !1) : (w.error(P.method, t), !1);
                            l = l[o]
                        }
                    })), e.isFunction(s) ? c = s.apply(o, n) : s !== i && (c = s), e.isArray(a) ? a.push(c) : a !== i ? a = [a, c] : c !== i && (a = c), s
                }
            ...
            g = {
                initialize: function () {
                    ...
                    lastScroll: function (e) {
                    ...
                    }, positions: function () {
                        {
                            var e = {height: w.height()}, t = {
                                ...
                                bottomPadding: parseInt(m.css("padding-bottom"), 10)
                            };
                    ...
                    direction: function (e) {
                        ...
                        e = e || k.scrollTop();
                        var t = g.cache.element, n = g.cache.window, i = g.get.scrollChange(e), o = t.height - n.height + p.offset, a = g.get.currentElementScroll(), r = a + i;
                    ...
                    offset: function () {
                        ...
                        0 !== g.cache.element.height && 0 !== g.cache.element.width && C.css({
                            width: g.cache.element.width,
                            height: g.cache.element.height
                        })
                    }
                }, is: {
                    top: function () {
                    ...
                    g.debug("Binding element to bottom of parent container"), g.remove.offset(), C.css({
                        left: "",
                        top: "",
                        marginBottom: g.cache.context.bottomPadding
                    ...
                    g.debug("Removing absolute position on element"), g.remove.offset(), C.removeClass(v.bound).removeClass(v.top).removeClass(v.bottom)
                }, unfix: function () {
                    g.debug("Removing fixed position on element"), g.remove.offset(), C.removeClass(v.fixed).removeClass(v.top).removeClass(v.bottom), p.onUnstick.call(A)
                }, reset: function () {
    ...
    e.fn.tab = function (o) {
        ...
        return r.each(function () {
            var g, p, v, h, b, y, x = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.tab.settings, o) : e.extend({}, e.fn.tab.settings), C = x.className, w = x.metadata, k = x.selector, S = x.error, T = "." + x.namespace, A = "module-" + x.namespace, R = e(this), P = {}, E = !0, O = 0, F = this, D = R.data(A);
            b = {
                initialize: function () {
                    ...
                    var i = t.history && t.history.pushState, o = i && x.ignoreFirstLoad && E, a = x.auto || e.isPlainObject(x.apiSettings), r = a && !o ? b.utilities.pathToArray(n) : b.get.defaultPathArray(n);
                    n = b.utilities.arrayToPath(r), e.each(r, function (t, i) {
                        var s, c, l, u, d = r.slice(0, t + 1), m = b.utilities.arrayToPath(d), f = b.is.tab(m), p = t + 1 == r.length, w = b.get.tabElement(m);
                        if (b.verbose("Looking for tab", i), f) {
                            if (b.verbose("Tab was found", i), v = m, h = b.utilities.filterArray(r, d), p ? u = !0 : (c = r.slice(0, t + 2), l = b.utilities.arrayToPath(c), u = !b.is.tab(l), u && b.verbose("Tab parameters found", c)), u && a)return o ? (b.debug("Ignoring remote content on first tab load", m), E = !1, b.cache.add(n, w.html()), b.activate.all(m), x.onFirstLoad.call(w[0], m, h, y), x.onLoad.call(w[0], m, h, y)) : (b.activate.navigation(m), b.fetch.content(m, n)), !1;
                            b.debug("Opened local tab", m), b.activate.all(m), b.cache.read(m) || (b.cache.add(m, !0), b.debug("First time tab loaded calling tab init"), x.onFirstLoad.call(w[0], m, h, y)), x.onLoad.call(w[0], m, h, y)
                        } else {
                            if (-1 != n.search("/") || "" === n)return b.error(S.missingTab, R, g, m), !1;
                            if (s = e("#" + n + ', a[name="' + n + '"]'), m = s.closest("[data-tab]").data("tab"), w = b.get.tabElement(m), s && s.length > 0 && m)return b.debug("Anchor link used, opening parent tab", w, s), w.hasClass(C.active) || setTimeout(function () {
                                b.scrollTo(s)
                            }, 0), b.activate.all(m), b.cache.read(m) || (b.cache.add(m, !0), b.debug("First time tab loaded calling tab init"), x.onFirstLoad.call(w[0], m, h, y)), x.onLoad.call(w[0], m, h, y), !1
                        }
                    })
                }, scrollTo: function (t) {
                    ...
                    initialPath: function () {
                        ...
                        if (n) {
                            if (b.debug("Found default tab", n), O < x.maxDepth)return O++, b.get.defaultPath(n);
                            b.error(S.recursion)
                        ...
                        var t, n, i, o;
                        return e = e || v, i = b.utilities.pathToArray(e), o = b.utilities.last(i), t = p.filter("[data-" + w.tab + '="' + o + '"]'), n = p.filter("[data-" + w.tab + '="' + e + '"]'), t.length > 0 ? t : n
                    }, tab: function () {
                        return v
                    }
                }, utilities: {
                    ...
                    var r, s, c, l = D;
                    return n = n || m, o = F || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
            ...
            C = {
                initialize: function () {
                    ...
                    animation: function (e) {
                        e = e || C.get.animationClass(), C.debug("Starting tween", e), w.addClass(e).one(b + ".complete" + x, C.complete), f.useFailSafe && C.add.failSafe(), C.set.duration(f.duration), f.onStart.call(this)
                    }
                }, save: {
                    animation: function (e) {
                    ...
                    C.verbose("Hiding element"), C.is.animating() && C.reset(), k.blur(), C.remove.display(), C.remove.visible(), C.set.hidden(), f.onHide.call(this), f.onComplete.call(this), C.force.hidden()
                }, show: function (e) {
                    C.verbose("Showing element", e), C.remove.hidden(), C.set.visible(), f.onShow.call(this), f.onComplete.call(this), C.force.visible()
                }, toggle: function () {
    ...
    e.api = e.fn.api = function (n) {
        ...
        return a.each(function () {
            var a, m, f, g, p, v, h = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.api.settings, n) : e.extend({}, e.fn.api.settings), b = h.namespace, y = h.metadata, x = h.selector, C = h.error, w = h.className, k = "." + b, S = "module-" + b, T = e(this), A = T.closest(x.form), R = h.stateContext ? e(h.stateContext) : T, P = this, E = R[0], O = T.data(S);
            v = {
                initialize: function () {
                    u || v.bind.events(), v.instantiate()
                }, instantiate: function () {
                    v.verbose("Storing instance of module", v), O = v, T.data(S, O)
                }, destroy: function () {
                    v.verbose("Destroying previous module for", P), T.removeData(S).off(k)
                }, bind: {
                    events: function () {
                        var e = v.get.event();
                        e ? (v.verbose("Attaching API events to element", e), T.on(e + k, v.event.trigger)) : "now" == h.on && (v.debug("Querying API now", e), v.query())
                    }
                }, read: {
                    cachedResponse: function (e) {
                        var n;
                        if (t.Storage === i)return void v.error(C.noStorage);
                        if (n = sessionStorage.getItem(e), v.debug("Using cached response", e, n), n !== i) {
                            try {
                                n = JSON.parse(n)
                            } catch (o) {
                            }
                    ...
                    return h.defaultData && e.extend(!0, h.urlData, v.get.defaultData()), h.serializeForm && (h.data = v.add.formData(h.data)), m = v.get.settings(), m === !1 ? (v.cancelled = !0, void v.error(C.beforeSend)) : (v.cancelled = !1, f = v.get.templatedURL(), f || v.is.mocked() ? (f = v.add.urlData(f), f || v.is.mocked() ? (a = e.extend(!0, {}, h, {
                    ...
                    disabled: function () {
                        ...
                        return "json" === h.dataType && e.isFunction(h.successTest) ? (v.debug("Checking JSON returned success", h.successTest, t), h.successTest(t) ? (v.debug("Response passed success test", t), !0) : (v.debug("Response failed success test", t), !1)) : (v.verbose("Response is not JSON, skipping validation", h.successTest, t), !0)
                    }
                }, was: {
                    cancelled: function () {
                    ...
                    urlData: function (t, n) {
                        ...
                        return t && (o = t.match(h.regExp.required), a = t.match(h.regExp.optional), n = n || h.urlData, o && (v.debug("Looking for required URL variables", o), e.each(o, function (o, a) {
                            ...
                            return s === i ? (v.error(C.requiredParameter, r, t), t = !1, !1) : (v.verbose("Found required variable", r, s), void(t = t.replace(a, s)))
                    ...
                    trigger: function (e) {
                        ...
                        always: function () {
                            ...
                            r = r > 0 ? r : 0, s && (v.debug("Modified API response in onResponse callback", h.onResponse, s, t), t = s), r > 0 && v.debug("Response completed early delaying state change by", r), setTimeout(function () {
                                v.is.validResponse(t) ? v.request.resolveWith(o, [t]) : v.request.rejectWith(o, [i, "invalid"])
                            }, r)
                        }, fail: function (e, t, n) {
                        ...
                        complete: function (e) {
                            v.remove.loading(), h.onComplete.call(E, e, T)
                        }, done: function (e) {
                            v.debug("Successful API Response", e), "local" === h.cache && f && (v.write.cachedResponse(f, e), v.debug("Saving server response locally", v.cache)), h.onSuccess.call(E, e, T)
                        }, fail: function (t, n, o) {
                            var r = e.isPlainObject(t) ? t.responseText : !1, s = e.isPlainObject(r) && r.error !== i ? r.error : h.error[n] !== i ? h.error[n] : o;
                            "aborted" == n ? (v.debug("XHR Aborted (Most likely caused by page navigation or CORS Policy)", n, o), h.onAbort.call(E, n, T)) : "invalid" == n ? v.debug("JSON did not pass success test. A server-side error has most likely occurred", r) : "error" == n && t !== i && (v.debug("XHR produced a server error", n, o), 200 != t.status && o !== i && "" !== o && v.error(C.statusMessage + o, a.url), h.onError.call(E, s, T)), h.errorDuration && "aborted" !== n && (v.debug("Adding error state"), v.set.error(), setTimeout(v.remove.error, h.errorDuration)), v.debug("API Request failed", s, t), h.onFailure.call(E, r, T)
                        }
                    }
                }, create: {
                    request: function () {
                        ...
                        return i = e.Deferred().always(v.event.xhr.complete).done(v.event.xhr.done).fail(v.event.xhr.fail), h.mockResponse ? (e.isFunction(h.mockResponse) ? (v.debug("Using mocked callback returning response", h.mockResponse), n = h.mockResponse.call(E, h)) : (v.debug("Using specified response", h.mockResponse), n = h.mockResponse), i.resolveWith(E, [n, o, {responseText: n}])) : e.isFunction(h.mockResponseAsync) && (t = function (e) {
                            v.debug("Async callback returned response", e), e ? i.resolveWith(E, [e, o, {responseText: e}]) : i.rejectWith(E, [{responseText: e}, a, r])
                    ...
                    request: function () {
                        ...
                        if (e) {
                            ...
                            f = h.api[e]
                        } else v.is.form() && (f = T.attr("action") || !1, v.debug("No url or action specified, defaulting to form action", f));
                        return f
                    }
                }, abort: function () {
                    var e = v.get.xhr();
            ...
            }, u ? (O === i && v.initialize(), v.invoke(l)) : (O !== i && O.invoke("destroy"), v.initialize())
        }), o !== i ? o : this
    }, e.api.settings = {
        name: "API",
        namespace: "api",
